...
public class Php7Target extends Target {
	...
	protected static final String[] php7Keywords = {
	...
	protected STGroup loadTemplates() {
		...
		if (result == null) {
			...
			result.registerRenderer(String.class, new Php7StringRenderer(), true);
	...
	protected static class Php7StringRenderer extends StringRenderer {
