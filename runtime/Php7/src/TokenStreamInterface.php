 ...
 */
interface TokenStream extends IntStreamInterface {
    /**
     ...
     *
     * @see IntStreamInterface#LA
     */
    public function LT(int $k): TokenInterface;
     ...
     */
    public function get(int $index): TokenInterface;
     ...
     */
    public function getTextByRuleContext(RuleContextInterface $ctx): string;
     ...
     */
    public function getTextByTokens(TokenInterface $start, TokenInterface $stop): string;
}
